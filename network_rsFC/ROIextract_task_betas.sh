...
subjects='193 194 198 211 212 216 218 225 229 237 238
240 242 244 247 248 250 254 257 258 259 263 266 268
273 279 280 282 283 285 287 289 290 291 293 294 295
297 299 301 302 306 307 309 310 311 313 314 315 316
317 318 319 320 321 323 324 326 328 331 332 333 334
336 337 339 340 341 342 343 344 345 346 348 350 351
352 354 357 360 363 365 366 370 373 375 378 383 387
388 389 392 397 398 399 401 402 403 404 405 407 409
410 300 358 253 380 206 217'

rois='RECN LECN SN DMN'

#put network masks in functional task data space
...
#Extract average error and correct task beta weights for each network
...
#put all subjects betas in one file
...
#Extract average aware error and unaware error task beta weights for each network
